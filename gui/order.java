...
kontrol_order ko;
String iddetailorder,idorder,nomeja,tanggal,iduser,keterangan,status,idminuman;
    ...
    private void initComponents() {
        ...
        lblidminuman = new javax.swing.JLabel();
        ...
        tabel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Minuman", "Minuman", "Harga", "Status Minuman"
            }
        ) {
        ...
        lblidminuman.setText("-");

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel12.setText("ID Minuman         ");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lblidminuman, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private javax.swing.JLabel lblidminuman;
...
private void tampildata() {
 ...
 private void settabel() {
     ...
     lblidminuman.setText(tabel.getValueAt(tabel.getSelectedRow(), 0).toString());
     ...
     if(status.equals("Kosong")){
         ...
         lblidminuman.setVisible(false);
         lblnama.setText("STATUS MINUMAN KOSONG");
 ...
 private void pesan() {
     ...
     idminuman = lblidminuman.getText();
     if (dtp.isSelected()){
         status = "Ditempat";
     } else {
         status = "Delivery";
     ...
     if (txtidorder.getText().isEmpty() || 
        ...
        ko.simpandatadetailorder(idorder, idminuman, keterangan, status);
