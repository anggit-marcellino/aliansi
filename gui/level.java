...
private void setformtable() {
     txtidlevel.setText(tbminuman.getValueAt(tbminuman.getSelectedRow(), 0).toString());
     txtnamalevel.setText(tbminuman.getValueAt(tbminuman.getSelectedRow(), 1).toString());
